...
public class SFTPServerImpl2 implements PasswordAuthenticator, PublickeyAuthenticator {

	public SFTPServerImpl2() {
	...
	//
	private final Logger LOG = LoggerFactory.getLogger(SFTPServerImpl2.class);
	private Config db;
	private SshServer sshd;
	//
	public static void main(final String[] args) {
		new SFTPServerImpl2().start();
	}
	...
	public void start() {
		...
		try {
			...
			final SFTPServerImpl2 thisServer = this;
	...
	static class SecureFileSystemView extends NativeFileSystemView implements FileSystemView {
		...
		protected SshFile getFile(final String dir, final String file) {
			...
			return new SecureSshFile(this, userFileName, fileObj, userName, isReadOnly);
		}
		@Override
	...
	static class SecureSshFile extends NativeSshFile {
		...
		//
		public SecureSshFile(SecureFileSystemView secureDfilesystemview, final String fileName, final File file, final String userName, final boolean isReadOnly) {
			super(secureDfilesystemview, fileName, file, userName);
			this.isReadOnly = isReadOnly;
		}
		//
